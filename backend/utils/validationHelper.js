...
const mahasiswaValidation = yup.object({
...
const mahasiswaValidationArray = yup.array().of(
    yup.object().shape({
        nim: yup.string().required('NIM Is Required'),
        nama: yup.string().required('Nama Mahasiswa Is Required'),
        email: yup.string().email('Email is invalid').nullable(),
...
const laboratoriumValidation = yup.object({
    nama: yup.string().required('Nama Laboratorium Is Required')
});

const praktikumValidation = yup.object({
...
const Peserta_PraktikumValidation = yup.object({
    nim: yup.string().required('NIM Is Required'),
...
const absensiValidation = yup.object({
...
const Record_Absensi = yup.object({
...
const thAkademikValidation = yup.object({
...
module.exports = {
    userValidation,
    mahasiswaValidation,
    mahasiswaValidationArray,
    laboratoriumValidation,
    praktikumValidation,
    Peserta_PraktikumValidation,
    absensiValidation,
    Record_Absensi,
    thAkademikValidation,
}